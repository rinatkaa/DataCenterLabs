...
- Линковые интерфейсы для стека ipv6 точка-точка в 10 vlan: подинтерфейс Eth [0..n].10, с тэгом 802.1q 10
...
*** Host-2 подключен через клиентский коммутатор с включенной агрегацией каналов LACP в режиме Active в демонстративных целях ***
